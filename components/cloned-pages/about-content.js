               ...
               <div class="modal-body">
                   ...
                   <div id="formDiv">
                       <p>Share your details to access Software Demo</p>
                           ...
                           <input type="hidden" name="_token" value="ylGbiV7ZfOES7ElGZZBrJeFSCi8Icc24zO040ttT">                           <div class="error-container"></div>
                           <div class="row">
                               <div class="col-lg-6">
...
<section style="margin-bottom:100px;">
        <div class="container">
                <div class="row">
                <div class="col-md-6 align-self-md-center wow fadeInLeft" data-wow-duration="1.1s" data-wow-delay=".3s"
                    style="visibility: visible; animation-duration: 1.1s; animation-delay: 0.3s; animation-name: fadeInLeft;">
                    <img src="https://www.eductrl.com/images/aboutus.jpg" alt=""
                        class="img-fluid">
                </div>
                <!-- Col End -->
                <div class="col-md-6 wow fadeInRight" data-wow-duration="1.1s" data-wow-delay=".3s"
                    style="visibility: visible; animation-duration: 1.1s; animation-delay: 0.3s; animation-name: fadeInRight;">
                    <div class="row">
            <div class="col-md-12 wow fadeInUp" data-wow-duration="1.1s" data-wow-delay=".3s" style="visibility: visible; animation-duration: 1.1s; animation-delay: 0.3s; animation-name: fadeInUp;">
                <p>DeenSoft is a Web/Mobile Software Development and Digital Agency with 10+ years of experience delivering software solutions for education businesses worldwide.</p>
                <p>Our rich experience, technology knowledge, high dedication helps in delivering software solutions with 100% customer satisfaction. Through our expertise, domain knowledge, technical knowledge, streamlined processes, we can help you transform your business, maximize performance and stay ahead of your competitors.</p>
                <p>With 10+ years of experience, we have the expertise to develop top quality software products, websites, web applications & SEO/SMO, Digital Marketing solutions.</p>
            </div>
            <!-- Col End -->
        </div>
                    <!-- About Bin End -->
                ...
                grecaptcha.execute(sitekey, {
                    ...
                    if (name == '' || email == '' || phone == '' || message == '') {
                        ...
                        $.post("https://www.eductrl.com/contact/send", {
                            ...
                            source: 'contact form',
                            captcha_token: token,
                            _token: "ylGbiV7ZfOES7ElGZZBrJeFSCi8Icc24zO040ttT"
                        }, function(data) {
...
export function AboutCloneContent() {
  return (
    <div
